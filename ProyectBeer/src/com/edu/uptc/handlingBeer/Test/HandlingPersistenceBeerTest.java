...
class HandlingPersistenceBeerTest {
	...
	public void scenerieOne() {
		...
		Beer beer3 = new Beer("SN-20250813-0001", "Corona", "Large", "4.5%", "Rubia", "Mexico");
		Beer beer4 = new Beer("SN-20250813-0003","Andina","Cerverza de trigo","3.0%","Rubia","Colombia");
		
		
		/** Se guarda en la lista*/ 
		assertTrue(this.hPB.addBeers(beer));
	...
	public void scenerieThreee() {
		/** Simulacion de que se encuentre la cerveza y que se busque una que no este registrada. */
	...
	public void scenerieFive() {
		/** Simulacion de agreagrar otro elemento al archivo plano con otros ya existentes y que se guarden. */
		this.hPB.loadFile(ETypeFile.FILE_PLAIN);
